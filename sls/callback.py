...
from typing import List, Any, Collection, Callable, Tuple, Union, Dict

from conda._vendor.auxlib.type_coercion import listify
from torch import nn, optim, Tensor
from torch._jit_internal import is_tuple
...
__all__ = ['AverageMetric', 'Callback', 'CallbackHandler', 'OptimWrapper', 'SmoothenValue', 'Scheduler',
           'annealing_cos', 'CallbackList',
...
class OptimWrapper():
    ...
    @classmethod
    def create(cls, opt_func: object, lr: object, layer_groups: object,
               wd: object = 0.,
               true_wd: object = False, bn_wd: object = True) -> object:
    ...
    def get_state(self):
        ...
        return {'opt_state': self.opt.state_dict(), 'lr': self._lr, 'wd': self._wd, 'beta': self._beta,
                'mom': self._mom,
